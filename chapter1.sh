...
echo "This is another line added to practice git merge from main branch"echo "This is a message I added to test how the stash works. I needed to add this cos I add already"
echo "adding this to test stash"
...
echo "added to practice git revert"
echo "This is another test I am adding for the purpose of going back and forth within the history"
